  ...
  <Layout title="Coming Soon - Clean Coming Soon Page (Tailwind CSS, NextJs & HTML5) created by themeptation.net">
    ...
    <div className="absolute bottom-5">
      <ul className="flex space-x-3">
        <li>
          <Link href="https://instagram.com/taperau">
            <a className="flex items-center justify-center w-10 h-10 transition duration-500 ease-in-out rounded-full bg-gray-50 hover:bg-red-500 hover:text-white hover:shadow-lg">
              <svg
                className="w-6 h-6"
                fill="currentColor"
                viewBox="0 0 24 24"
